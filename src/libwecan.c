 ...
 */
static void compute_indexes(const uint16_t startbit, const uint8_t length, uint8_t endianness, 
 ...
 */
static uint64_t frame_to_local(const uint8_t *frame, uint16_t byte_index_lsb, 
...
void encode_uint64_t(uint8_t *frame, uint64_t physical_value, uint16_t startbit,
                uint8_t length, uint8_t endianness, 
